...
class FedAvg(Strategy):
    ...
    def __init__(
        self,
        *,
        fraction_fit: float = 0.5,#1.0,
        fraction_evaluate: float = 1/8,
    ...
    def aggregate_fit(
        ...
        acc_aggregated = weighted_acc_avg(
            [
                (fit_res.num_examples, fit_res.metrics['accuracy'])
                for _, fit_res in results
            ]
        )
    ...
    def aggregate_evaluate(
        ...
        return loss_aggregated, acc_aggregated, metrics_aggregated
